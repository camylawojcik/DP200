AZURE DATA LAKE STORAGE
	...
	- Onde usar: grandes quantidades de dados; reduz tempo de processamento, tornando a
	...
	- Zone and Geo Redundant (LRS) (GRS)
	- Hierarchical Namespaces: 
		- organiza o blob em diretórios e armazena metadados sobre cada diretório e arquivos
		  Permitindo renomear e deletar em uma única operação atômica;
	...
	- Cobrado por armazenamento (tiers), transação (https://azure.microsoft.com/pt-br/pricing/details/storage/data-lake/)
	- Monitoramento: Azure Monitor (tem mais algum?)
